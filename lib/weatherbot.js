...
module.exports = class WeatherBot {
    constructor({host, port, tlsEnabled, nick, channels}) {
        ...
        this.client.on('timeout', function() {
            console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}]   Connection to ${host} timed out`);
        });
        ...
        this.client.on('close', () => {
            console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}]   Connection to ${host} closed`);
        });
    }
    ...
    sendInitialConnectionMessages() {
        ...
        console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}]   Connected to ${this.host}:${this.port}`);
    ...
    joinChannels() {
        this.channels.forEach(channel => {
            ...
            console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}]   Joined ${channel.name}`);
        });
    }
